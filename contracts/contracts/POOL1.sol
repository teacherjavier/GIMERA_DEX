...
contract Pool1 is ERC20 {
    ...
    constructor(address _tokenA, address _tokenB, address _aiAddress) ERC20("Liquidity Provider Token 1", "LP_1") {
        ...
        // Initial reserves
        tokenA.safeTransferFrom(msg.sender, address(this), 2000 * 10**decimals());
        tokenB.safeTransferFrom(msg.sender, address(this), 1000 * 10**decimals());
    }
